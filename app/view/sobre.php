<div class="header-title ken-burn-out white" style="background-image: url('images/equipe.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <h2>
                    ...
                    Uma empresa familiar com ampla capacidade de diversificar, antever oportunidades e nichos de mercado e que busca ser referência nas suas áreas de atuação.
    ...
    <div class="container content">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <p class="text-xs text-uppercase">colaboradores</p>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <p class="text-xs text-uppercase">estados br - Região Norte</p>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <p class="text-xs text-uppercase">desenvolvidos</p>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <p class="text-xs text-uppercase">de atuação</p>
    ...
    <div class="container content">
        ...
        <div class="row proporzional-row proporzional-row-sm">
            ...
            <div class="col-md-4 boxed white">
                ...
                <h2 class="text-color">Missão</h2>

                <p>

                    Fazer o melhor em soluções de transporte e movimentação de cargas complexas, customização de contêineres, distribuição e locação de equipamentos, com equipes capacitadas e tecnologia de última geração.
            ...
            <div class="col-md-4 boxed white">
                ...
                <h2 class="text-color">Visão</h2>

                <p>

                    Ser referência em soluções de transporte e movimentação de cargas complexas, customização de contêineres, distribuição e locação de equipamentos da Região Norte, proporcionando o melhor ambiente de trabalho e capacitação às suas equipes.
        ...
        <div class="row proporzional-row proporzional-row-sm">
            ...
            <div class="col-md-4 boxed white">
                ...
                <h2 class="text-color">Valores</h2>
    ...
    <div class="container content">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <h2>SEDE PRINCIPAL ENTEC (Av. Autaz Mirim)</h2>
                ...
                <h2>FILIAL ENTEC (Av. Solimões)</h2>
