            ...
            <div class="row proporzional-row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <form action="" class="form-box" method="post">
                        ...
                        <button class="btn-sm btn">Send</button>
                ...
                <div class="col-md-6 col-sm-12 boxed-inverse">
                    ...
                    <ul class="list-texts list-texts-justified">
                        ...
                        <li><b>Address:</b> <span>Av. Autaz Mirim, 1383 - Distrito Industrial I<br> Manaus - AM CEP: 69075-155</span></li>

                        <li><b>Phones:</b> <span>+55 (92) 3647-2000</span></li>
