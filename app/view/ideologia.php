<div class="header-title ken-burn-out white" style="background-image: url('images/ideologia.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <div class="container">
        <div class="title-base">
            <hr class="anima" />
            <h1>Conheça a IDEOLOGIA da ENTEC</h1>
            <p> </p>
        </div>
    </div>
</div>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <hr class="space m" />
                <h2>
                    Uma empresa familiar ENTEC com ampla capacidade de diversificar, antever oportunidades e nichos de mercado e que busca ser referência nas suas áreas de atuação.
                </h2>
            </div>
            <div class="col-md-4 col-sm-6">
                <hr class="space m" />
...
<div class="header-title ken-burn-out white" style="background-image: url('images/Dest/Juntos2.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <div class="container">
        <div class="title-base">
            <hr class="anima" />
            <h1> </h1>
